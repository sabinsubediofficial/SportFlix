      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <section className="bg-gray-900 border border-gray-800 rounded-2xl overflow-hidden shadow-xl">
            ...
            <div className="p-8 space-y-6">
              ...
              <button 
                ...
                className={`group w-full py-4 rounded-xl font-black text-lg transition-all flex items-center justify-center space-x-3 ${
                  mutation.isPending 
        ...
        <div className="space-y-8">
          ...
          <div className="p-6 rounded-2xl bg-gradient-to-br from-gray-900 to-black border border-gray-800">
            ...
            <p className="text-xs text-gray-500 mb-4">You are currently using the open-source version of SportFlix.</p>
